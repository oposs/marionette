...
mod tests {
    ...
    // -- Phase 14 Plan 04 Checkbox extensions (D-B3, D-C4) --
    ...
    // -- Phase 14 Plan 05 Textarea (new primitive, D-E3) --
    ...
    // -- Phase 14 Plan 07 FieldSet + FieldSeparator (structural components, D-C1 + D-C2) --
